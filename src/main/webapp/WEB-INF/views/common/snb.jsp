		...
		<div class="sidenav-menu">
			<div class="nav accordion" id="accordionSidenav">
				...
				<a class="nav-link d-sm-none" href="#!">
					...
					</div> Messages <span class="badge bg-success-soft text-success ms-auto">2
						New!</span>
				</a>
				...
				<div class="collapse" id="collapsePages"
					...
					<nav class="sidenav-menu-nested nav accordion"
						...
						<a class="nav-link collapsed" href="javascript:void(0);"
							data-bs-toggle="collapse" data-bs-target="#pagesCollapseAccount"
						...
						<div class="collapse" id="pagesCollapseAuth"
							...
							<nav class="sidenav-menu-nested nav accordion"
								...
								<div class="collapse" id="pagesCollapseAuthSocial"
									data-bs-parent="#accordionSidenavPagesAuth">
									<nav class="sidenav-menu-nested nav">
										<a class="nav-link" href="auth-login-social.html">Login</a> <a
											class="nav-link" href="auth-register-social.html">Register</a>
				...
				<div class="collapse" id="collapseApps"
					...
					<nav class="sidenav-menu-nested nav accordion"
						...
						<a class="nav-link collapsed" href="javascript:void(0);"
							...
							aria-controls="appsCollapseKnowledgeBase"> Knowledge Base
							<div class="sidenav-collapse-arrow">
								<i class="fas fa-angle-down"></i>
							</div>
						</a>
						...
						<a class="nav-link collapsed" href="javascript:void(0);"
							...
							aria-expanded="false" aria-controls="appsCollapseUserManagement">
							User Management
							<div class="sidenav-collapse-arrow">
								<i class="fas fa-angle-down"></i>
							</div>
						...
						<div class="collapse" id="appsCollapseUserManagement"
							data-bs-parent="#accordionSidenavAppsMenu">
							<nav class="sidenav-menu-nested nav">
								<a class="nav-link" href="user-management-list.html">Users
									List</a> <a class="nav-link" href="user-management-edit-user.html">Edit
									User</a> <a class="nav-link" href="user-management-add-user.html">Add
									User</a> <a class="nav-link"
									href="user-management-groups-list.html">Groups List</a> <a
									class="nav-link" href="user-management-org-details.html">Organization
									Details</a>
							</nav>
						</div>
						...
						<a class="nav-link collapsed" href="javascript:void(0);"
							...
							aria-expanded="false" aria-controls="appsCollapsePostsManagement">
							Posts Management
							<div class="sidenav-collapse-arrow">
								<i class="fas fa-angle-down"></i>
							</div>
						...
						<div class="collapse" id="appsCollapsePostsManagement"
							data-bs-parent="#accordionSidenavAppsMenu">
							<nav class="sidenav-menu-nested nav">
								<a class="nav-link" href="blog-management-posts-list.html">Posts
									List</a> <a class="nav-link"
									href="blog-management-create-post.html">Create Post</a> <a
									class="nav-link" href="blog-management-edit-post.html">Edit
									Post</a> <a class="nav-link"
									href="blog-management-posts-admin.html">Posts Admin</a>
							</nav>
						</div>
					</nav>
				</div>
				...
				<a class="nav-link collapsed" href="javascript:void(0);"
					data-bs-toggle="collapse" data-bs-target="#collapseFlows"
					...
					<nav class="sidenav-menu-nested nav accordion"
						...
						<div class="collapse" id="collapseLayoutSidenavVariations"
							...
							<nav class="sidenav-menu-nested nav">
								...
								<a class="nav-link" href="layout-dark.html">Dark Sidenav</a> <a
									class="nav-link" href="layout-rtl.html">RTL Layout</a>
							</nav>
						</div>
