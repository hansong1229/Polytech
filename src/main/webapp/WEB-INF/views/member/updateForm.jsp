				...
				<input type="hidden" id="memPassword" name="memPassword" value="">
					<table class="table table-bordered"
						...
						<tr>
							...
							<td><input onkeyup="passwordCheck()" maxlength="20"
								...
								<div class="form-group"
									...
									<div class="btn-group" data-toggle="buttons">
										...
										<label class="btn btn-primary"> <input
											type="radio" id="memGender" name="memGender"
											autocomplete="off" value="남자">남자
										</label> <label class="btn btn-primary active"> <input type="radio"
											id="memGender" name="memGender" autocomplete="off" value="여자"  checked="checked">여자
										</label>
										</c:if>
						...
						<tr>
							...
							<td><input value="${mvo.memEmail}" maxlength="50"
